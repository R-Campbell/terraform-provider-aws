        ...
        Ec2Fleet(self, "example",
            launch_template_config=[Ec2FleetLaunchTemplateConfig(
                launch_template_specification=Ec2FleetLaunchTemplateConfigLaunchTemplateSpecification(
                    launch_template_id=Token.as_string(aws_launch_template_example.id),
...
from imports.aws.ec2_fleet import Ec2Fleet
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name, *, targetCapacitySpecification):
        super().__init__(scope, name)
        Ec2Fleet(self, "example",
            launch_template_config=[Ec2FleetLaunchTemplateConfig(
                override=[Ec2FleetLaunchTemplateConfigOverride(
