...
Import EKS Identity Provider Configurations using the `clusterName` and `identityProviderConfigName` separated by a colon (`:`). For example:

```
$ terraform import aws_eks_identity_provider_config.my_identity_provider_config my_cluster:my_identity_provider_config
```

<!-- cache-key: cdktf-0.17.1 input-2be81b4a4ced7eaf230e9d15d87bbe38ba846eb5d15cd9504158b6f89f508763 -->