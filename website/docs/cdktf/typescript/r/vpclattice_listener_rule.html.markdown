...
Import VPC Lattice Listener Rule using the `exampleIdArg`. For example:

```
$ terraform import aws_vpclattice_listener_rule.example rft-8012925589
```

<!-- cache-key: cdktf-0.17.1 input-a7b8db53b62dc67e00cbc184e230ae353d4ec7a0b2e6acab0175bd5abc37d1d3 -->