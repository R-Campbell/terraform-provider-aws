...
To import Prefix List Entries, use the `prefixListId` and `cidr`. Separate them with a comma (`,`). For example:

```
$ terraform import aws_ec2_managed_prefix_list_entry.default pl-0570a1d2d725c16be,10.0.3.0/24
```

<!-- cache-key: cdktf-0.17.1 input-cb2429419605c44517efaaebfaf6d3bce2add90c9e5c6e48403e50a322509a8a -->