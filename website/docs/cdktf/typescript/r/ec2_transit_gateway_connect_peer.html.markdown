...
Import `awsEc2TransitGatewayConnectPeer` using the EC2 Transit Gateway Connect Peer identifier. For example:

```
$ terraform import aws_ec2_transit_gateway_connect_peer.example tgw-connect-peer-12345678
```

<!-- cache-key: cdktf-0.17.1 input-193389d6449eac32b35d9ccec501a721982f544c15c07464a58ac55794ed5544 -->