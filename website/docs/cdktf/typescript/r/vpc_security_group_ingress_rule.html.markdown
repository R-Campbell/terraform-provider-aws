...
Import Security group ingress rules using the `securityGroupRuleId`. For example:

```
$ terraform import aws_vpc_security_group_ingress_rule.example sgr-02108b27edd666983
```

<!-- cache-key: cdktf-0.17.1 input-156ac97759e5800ff53c0c1ec094a1c3ea161e811ad2895d3d847c37e124ea49 -->